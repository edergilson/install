...
sudo pacman -Sy xfce4 xfce4-goodies networkmanager ttf-dejavu ttf-hack ttf-liberation cantarell-fonts noto-fonts lightdm lightdm-gtk-greeter libinput xf86-input-evdev
