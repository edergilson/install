...
PACKAGE="qbittorrent tilix pidgin plank pavucontrol pulseaudio remmina"
...
yay -S google-chrome opera-ffmpeg-codecs vivaldi libreoffice-fresh neofetch-git sublime-text-dev visual-studio-code-bin gitkraken gargoyle-git rambox-bin smartgit insomnia sweethome3d sweethome3d-furniture-library brave-bin freerdp sublime-merge
