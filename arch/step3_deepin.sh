...
sudo pacman -Syu deepin deepin-extra ttf-dejavu ttf-hack ttf-liberation cantarell-fonts noto-fonts xorg xorg-xinit libinput xf86-input-evdev networkmanager lightdm
