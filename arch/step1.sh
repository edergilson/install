...
pacstrap /mnt bash bzip2 dialog wpa_supplicant cryptsetup device-mapper dhcpcd e2fsprogs findutils gawk gcc-libs gettext glibc inetutils iproute2 jfsutils licenses logrotate lvm2 man-db mdadm nano netctl pacman pciutils perl procps-ng psmisc s-nail shadow sysfsutils systemd-sysvcompat texinfo usbutils util-linux vi vim xfsprogs networkmanager
